...
public class UserControllerTest {
    //執行測試前要先將UserDaoImpl SQL中的 user 改成 'user'，應對H2資料庫
    @Autowired
    ...
    void register_success() throws Exception {
        ...
        userRegisterRequest.setEmail("test6@mail.com");
        userRegisterRequest.setPassword("b12345678");
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.email", equalTo("test6@mail.com")))
